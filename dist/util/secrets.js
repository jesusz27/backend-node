...
if (fs_1.default.existsSync(".env")) {
    ...
    dotenv_1.default.config({ path: ".enviroment" }); // you can delete this after you create your own .env file!
}
...
exports.TOKEN_SECRET = process.env["TOKEN_SECRET"] || "clavetoken";
